...
def dashboard():
    ...
    if user_id and user_type:
        if user_type == 'recruiter':
            ...
            if user_id == 'specific_user_id':  # Check for specific management user
